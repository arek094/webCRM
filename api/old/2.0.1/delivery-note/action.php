    ...
    switch ($action) {
        ...
        case 2:
            ...
            $query_insert_poz="INSERT INTO t_wydanie_poz_dost (wydanie_nag_dost_id, nr_poz , wytwor_id,ilosc,zam_poz_dost_id)
                        SELECT $id, @lp:=@lp+1 as nr_poz, wytwor_id, SUM(ilosc) AS ilosc,zam_poz_dost_id
        ...
        case 3:
            ...
            break;    
        case 4:
            $query="UPDATE t_wydanie_nag_dost SET status_id=2  WHERE wydanie_nag_dost_id='$deliverydata'";
            $result=mysqli_query($mysqli,$query);
        
            if (isset($result)){            
                $output = array('error'  => false,'message' => 'Wydanie zostało poprawnie zatwierdzone.');
            } else{
